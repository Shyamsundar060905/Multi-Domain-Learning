...
class LEVIRFewShotDataset(Dataset):
    ...
    #     # ✅ Stack ONLY ONCE here
    #     s_img1 = torch.stack(s_img1)
    #     s_img2 = torch.stack(s_img2)
    #     s_mask = torch.stack(s_mask)
    
    #     q_img1 = torch.stack(q_img1)
    #     q_img2 = torch.stack(q_img2)
    #     q_mask = torch.stack(q_mask)
    
    #     return s_img1, s_img2, s_mask, q_img1, q_img2, q_mask